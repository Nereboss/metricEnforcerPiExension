...
- Fix "error" violations immediately by refactoring the affected file, except for a clearly pre-existing violation whose remediation would be disproportionate to the current task. Use `waive_metric_file` only for that exception.x
